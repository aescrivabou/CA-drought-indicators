...
**Principal Investigators:** Alvar Escriva-Bou (lead investigator) aescriva@ucdavis.edu (UCLA, UC Davis); Ellen Hanak and Jeffrey Mount (Public Policy Institute of California)
...
**IMPORTANT NOTE: AS OF June 17, 2025, THIS REPOSITORY IS STILL UNDER DEVELOPMENT AND REVIEW. PLEASE, CONTACT THE DEVELOPERS BEFORE USING ANY OF THE CODE OR RESULTS**
...
* **[Documents](https://github.com/aescrivabou/CA-drought-indicators/tree/main/Phase%201/Documents)**: includes the description of three methodologies developed during the project (including sources of data, code, and results) and the slides of the final workshop:
  ...
  * [Final workshop slides](https://github.com/aescrivabou/CA-drought-indicators/blob/main/Phase%201/Documents/230508_NIDIS_Final%20Workshop.pdf)
* **[Functions](https://github.com/aescrivabou/CA-drought-indicators/tree/main/Phase%201/Functions)**: includes all the code developed during the project. It is explained and linked properly in the description of the three methodologies
* **[Data](https://github.com/aescrivabou/CA-drought-indicators/tree/main/Phase%201/Data)**: Includes the input data, the data downloaded to develop the indicators, the processed data (or intermediate results), and the results and visuals. As some of this data is too large, we include links to dropbox files, but following the methods and code described, anyone should be able to reproduce all results.
